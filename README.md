...
[重排链表](https://github.com/Ray-ux/LeetCode/blob/master/src/linkedlist/ReorderList.java)  </br>
[删除排序链表中的重复元素]() </br>
...
[机器人的运动范围](https://github.com/Ray-ux/LeetCode/blob/master/src/recall/RobotMoveArea.java)
### 二叉树
...
[外观数列](https://github.com/Ray-ux/LeetCode/blob/master/src/string/CountAndSay.java) </br>
[删除一个字符串中所有出现的字符串](https://github.com/Ray-ux/LeetCode/blob/master/src/string/RemoveAllOccurrencesOfASubstring.java)  </br>
...
[调整数组顺序使奇数位于偶数前面](https://github.com/Ray-ux/LeetCode/blob/master/src/math/ChangeArrayPosition.java)
